...
public class SlimeSummonModel extends EntityModel<SlimeSummonEntity> {
    ...
    public SlimeSummonModel(ModelPart modelPart) {
        this.base = modelPart.getChild(EntityModelPartNames.CUBE);
    }
    @Override
    public void setAngles(SlimeSummonEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
